...
This shows basic usage of a simple print with a cube stl file, and a gyroid unit
cell.
...
def main_function():
    ...
    output_directory = Path('~/Desktop').expanduser() / 'basic_usage_output'
